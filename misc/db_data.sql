...
INSERT INTO user_account (username, email, password, first_name, last_name,
    gender, phone_num, city_id, country_id, date_of_birth,
    date_joined, description, is_admin)
VALUES('Bob123', 'bob@email.com', 'abcdef123456', 'Bob', 'Martin', 'm', 1234567890, 1, 1, '12/12/1980', '12/12/2014', 'Hi, I am Bob', false);
